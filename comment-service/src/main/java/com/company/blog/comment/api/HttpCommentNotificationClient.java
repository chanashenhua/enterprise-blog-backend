...
@Component
public class HttpCommentNotificationClient implements CommentNotificationClient {
    private static final ObjectMapper OBJECT_MAPPER = new ObjectMapper();

    private final RestClient restClient;
    private final String internalToken;

    public HttpCommentNotificationClient(
    ...
    public void send(String eventId, String payloadJson) {
        try {
            ...
            throw new IllegalStateException("Unable to deliver comment notification", ex);
        }
    }
}
